...
test("ArchiveHeaderParser.parse should parse reserved1 as 2 bytes", () => {
    expect(hammingWeight(parseHeader("reserved1", "ffffffffffff00ffff"))).toBe(16);
    expect(hammingWeight(parseHeader("reserved1", "ffffffffffff00fff0"))).toBe(12);
...
test("ArchiveHeaderParser.parse should parse reserved2 as 4 bytes", () => {
    expect(hammingWeight(parseHeader("reserved2", "ffffffffffffffff00ffffffffff"))).toBe(32);
    expect(hammingWeight(parseHeader("reserved2", "ffffffffffffffff00ffffff00ff"))).toBe(24);
    expect(hammingWeight(parseHeader("reserved2", "ffffffffffffffff00ffff0000ff"))).toBe(16);
    expect(hammingWeight(parseHeader("reserved2", "ffffffffffffffff00ff000000ff"))).toBe(8);
    expect(hammingWeight(parseHeader("reserved2", "ffffffffffffffff0000000000ff"))).toBe(0);
});
test("ArchiveHeaderParser.parse should parse reserved2 as little endian", () => {
    expect(parseHeader("reserved2", "ffffffffffffffffff12345678")).toBe(0x78563412);
    expect(parseHeader("reserved2", "ffffffffffffffffff78563412")).toBe(0x12345678);
});
test("ArchiveHeaderParser.parse should parse hasVolumeAttributes flag", () => {
    expect(parseHeader("hasVolumeAttributes", btoh(0b100000000000000000000000001))).toBeTruthy();
    expect(parseHeader("hasVolumeAttributes", btoh(0b100000000000000000000000000))).toBeFalsy();
});
test("ArchiveHeaderParser.parse should parse hasComment flag", () => {
    expect(parseHeader("hasComment", btoh(0b100000000000000000000000010))).toBeTruthy();
    expect(parseHeader("hasComment", btoh(0b100000000000000000000000000))).toBeFalsy();
});
test("ArchiveHeaderParser.parse should parse isLocked flag", () => {
    expect(parseHeader("isLocked", btoh(0b100000000000000000000000100))).toBeTruthy();
    expect(parseHeader("isLocked", btoh(0b100000000000000000000000000))).toBeFalsy();
});
test("ArchiveHeaderParser.parse should parse hasSolidAttributes flag", () => {
    expect(parseHeader("hasSolidAttributes", btoh(0b100000000000000000000001000))).toBeTruthy();
    expect(parseHeader("hasSolidAttributes", btoh(0b100000000000000000000000000))).toBeFalsy();
});
test("ArchiveHeaderParser.parse should parse isNewNameScheme flag", () => {
    expect(parseHeader("isNewNameScheme", btoh(0b100000000000000000000010000))).toBeTruthy();
    expect(parseHeader("isNewNameScheme", btoh(0b100000000000000000000000000))).toBeFalsy();
});
test("ArchiveHeaderParser.parse should parse hasAuthInfo flag", () => {
    expect(parseHeader("hasAuthInfo", btoh(0b100000000000000000000100000))).toBeTruthy();
    expect(parseHeader("hasAuthInfo", btoh(0b100000000000000000000000000))).toBeFalsy();
});
test("ArchiveHeaderParser.parse should parse hasRecovery flag", () => {
    expect(parseHeader("hasRecovery", btoh(0b100000000000000000001000000))).toBeTruthy();
    expect(parseHeader("hasRecovery", btoh(0b100000000000000000000000000))).toBeFalsy();
});
test("ArchiveHeaderParser.parse should parse isBlockEncoded flag", () => {
    expect(parseHeader("isBlockEncoded", btoh(0b100000000000000000010000000))).toBeTruthy();
    expect(parseHeader("isBlockEncoded", btoh(0b100000000000000000000000000))).toBeFalsy();
});
test("ArchiveHeaderParser.parse should parse isFirstVolume flag", () => {
    expect(parseHeader("isFirstVolume", btoh(0b100000000000000000000000000000001))).toBeTruthy();
    expect(parseHeader("isFirstVolume", btoh(0b100000000000000000000000000000000))).toBeFalsy();
});
