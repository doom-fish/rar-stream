...
import FileMedia from '../../src/file/FileMedia';

describe('FileMedia', () => {
  let instance;
  beforeEach(() => {
    instance = new FileMedia({name: "Instance", createReadStream: () => ({on: (name, cb) => cb()})});
  });
  ...
  describe("#createReadStream", () => {
    ...
    it('should subscribe to events ', () => {
      ...
      let torrentCreateReadStreamInstance = new FileMedia(torrentFile);
      torrentCreateReadStreamInstance.createReadStream(0, 20).then(() => {
